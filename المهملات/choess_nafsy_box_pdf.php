...
function test_input($data) {
    ...
    $pdf= new TCPDF('p','mm','A4',true,'UTF-8',false);
        ...
        $pdf->Cell(50,8,'تاريخ السداد :',1,1,'C',0);
        ...
        $pdf->Cell(50,8,$pat_date_now,'B',1,'C',0);
...
if($chose[$i]==10){
    $total= $total+2000;
    $pdf->Cell(140,8,'اختبار الشخصيه المتعدده الاوجه MMPI السعر * 2000 ',1,1,'C',0);
}
if($chose[$i]==11){
    $total= $total+1000;
...
if($chose[$i]==20){
    $total= $total+3000;
    $pdf->Cell(140,8,'اختبار وكسلر لذكاء المراهقين والبالغين السعر * 3000',1,1,'C',0);
}
if($chose[$i]==21){
    $total= $total+3000;
    $pdf->Cell(140,8,'اختبار وكسلر لذكاء الاطفال ما قبل سن المراهقه السعر * 3000',1,1,'C',0);
}
