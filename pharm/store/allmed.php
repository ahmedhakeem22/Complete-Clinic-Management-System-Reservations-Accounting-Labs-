...
if ($conn->connect_error) {
  ...
  mysqli_select_db($conn,"najmdb");
    ...
    $r=mysqli_query($conn,"SELECT * FROM buy_invpice ");
...
<main>
      ...
      <tr>
      <td colspan='2'>
      <label style="background-color:#04922B; height:50px; text-align:center; font-size:25px; " class=" form-control  " > <strong style="color:white;" >  المشتـــريـــات     </strong> </label>
      </td>
      ...
      <td>
             <input class="btn btn-info form-control " name="btn" type="button" onclick="window.location.href='betweendate.php'" title=" بحــث بين تاريخيــن " value="بحــث بين تاريخيــن" />
             </td>
      </tr>
</table>
