...
if ($conn->connect_error) {
  ...
  mysqli_select_db($conn,"najmdb");
    ...
    $r=mysqli_query($conn,"SELECT name_med,name_sinc,countity,num_bact,date_do,expired_date,date_buy,buy_price,copny_name,delegate FROM buy_invpice WHERE expired_date < DATE_ADD('$date', INTERVAL 3 MONTH) AND expired_date > DATE_SUB('$date' , INTERVAL 1 DAY) ");
...
<main>
      ...
      <tr>
      <td>
      <label style="background-color:#B2051A; height:50px; text-align:center; font-size:25px; " class=" form-control  " > <strong style="color:white;" > الأدويـــة المقــاربــة على الانتهـــاء </strong> </label>
      </td>
