...
if ($conn->connect_error) {
  ...
  mysqli_select_db($conn,"najmdb");
    ...
    $r=mysqli_query($conn,"SELECT name_med,name_chemical,company,delegate FROM mediciness ");
...
<main>
      ...
      <tr>
      <td>
      <label style="background-color:#04922B; height:50px; text-align:center; font-size:25px; " class=" form-control  " > <strong style="color:white;" >  المخــــزن     </strong> </label>
      </td>
