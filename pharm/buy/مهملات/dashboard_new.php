...
$contant=' \r \n '.$contant."المندوب ".$delegate." سعر الشراء ".$buy_price."سعر البيع ".$sale_price." اسم العلاج".$_GET['name_med'];
...
if(isset($_GET['submit_prn'])){
    $decrip="شراء";
    $insert_med_inv = "INSERT INTO invoice_pharm(date_invo,typeinvoice,decrip) values ('$date','$contant','$decrip')";    
