...
$sql = "SELECT invoice_id,pat_id, fname, name_ser, cost_ser, invoice_date FROM invoice WHERE invoice_id = ?";
            ...
            <div class="invoice-body">
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <p><strong>المعرف  :</strong> <?php echo htmlspecialchars($invoice['pat_id']); ?></p>
                    </div>
