            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item active">
                        <a class="nav-link" href="lab2.php">الرئيسية<span class="visually-hidden">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disabled" href="#">الأخبار</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disabled" href="#">اتصل بنا</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disabled" href="#">حول</a>
                    </li>
